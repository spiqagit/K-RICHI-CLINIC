    ...
    <main class="bl_commonLowPageWrapper">
        <div class="bl_commonLowPageWrapper_ttlContainer">
            <hgroup class="bl_commonLowPageWrapper_ttl">
                <h1 class="el_commonLowPageWrapper_ttl_en">News</h1>
                <p class="el_commonLowPageWrapper_ttl_ja"><span>お知らせ</span></p>
            </hgroup>
        </div>
                                        ...
                                        <ul class="bl_newsArchiveList">
                                            <?php while (have_posts()) : the_post(); ?>
                                                <li class="bl_newsArchiveItem">
                                                    <a href="<?php the_permalink(); ?>" class="bl_newsArchiveItem_link">
                                                        <time class="el_newsArchiveItem_date" datetime="<?php echo get_the_date('Y-m-d'); ?>">
                                                            <?php echo get_the_date('Y.m.d'); ?>
                                                        </time>
                                                        <p class="el_newsArchiveItem_ttl"><?php the_title(); ?></p>
                                                    </a>
                                                </li>
                                            <?php endwhile; ?>
                                        </ul>
