...
"></script>
    ...
    <?php if (is_page('guide')): ?>
        <script type="module" src="<?php echo get_template_directory_uri(); ?>/assets/js/guide.js"></script>
    <?php endif; ?>
    ...
    <?php if (is_post_type_archive('faq')): ?>
        <script type="module" src="<?php echo get_template_directory_uri(); ?>/assets/js/faq.js"></script>
    <?php endif; ?>
    <!-- css -->
