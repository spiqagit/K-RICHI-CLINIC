    ...
    <main class="bl_commonLowPageWrapper">
        <div class="bl_commonLowPageWrapper_ttlContainer">
            <hgroup class="bl_commonLowPageWrapper_ttl">
                <h1 class="el_commonLowPageWrapper_ttl_en">Guide</h1>
                <p class="el_commonLowPageWrapper_ttl_ja"><span>初めての方へ</span></p>
            </hgroup>
        </div>
        <div class="bl_commonLowPageWrapper_contentsOuter bl_guideContentsOuter">
            <div class="bl_commonLowPageWrapper_contents bl_guideContents">
                <div class="bl_commonLowPageWrapper_contents_inner bl_guideContentsInner">
                    <section class="bl_guideAboutSection">
                        <div class="bl_guideAboutSection_inner">
                            <h2 class="el_guideAboutSection_ttl">当院を初めて受診される方へ</h2>
                            <div class="bl_guideAboutSection_contentWrapper">
                                <div class="bl_guideAboutSection_contentWrapper_txtContainer">
                                    <p class="el_guideAboutSection_contentWrapper_txtContainer_txt">初めて当院のページをご覧いただきありがとうございます。</p>
                                    <p class="el_guideAboutSection_contentWrapper_txtContainer_txt">当院は、韓国美容の先進的な技術と日本医療の繊細な品質を融合させ、<br>
                                        ｢美しく、健やかに生きる」ことをサポートすることを理念としております。</p>
                                    <p class="el_guideAboutSection_contentWrapper_txtContainer_txt">初めての方にも安心してお越しいただけるよう、丁寧なカウンセリングと
                                        確かな技術、そして落ち着いた空間づくりを大切にしております。</p>
                                    <p class="el_guideAboutSection_contentWrapper_txtContainer_txt">皆さま一人ひとりの“美しさ”と“自信”を引き出すために、<br>
                                        スタッフ一同、心を込めてサポートいたします。</p>
                                </div>

                                <div class="bl_guideAboutSection_imgWrapper">
                                    ...
                                    <div class="bl_guideAboutSection_imgSlider_pagination"></div>
                                </div>
                            </div>
                        </div>
                    </section>

                    <div class="bl_guideReserveContainer">
                        <div class="bl_guideReserveContainer_inner">
                            <div class="bl_guideReserveContainer_txtWrapper">
                                <div class="bl_guideReserveContainer_ttlWrapper">
                                    <h3 class="el_guideReserveContainer_ttl">ご予約方法</h3>
                                    <p class="el_guideReserveContainer_subTtl">Reserve</p>
                                </div>
                                <div class="bl_guideReserveContainer_txtWrapper">
                                    <p class="el_guideReserveContainer_txt">ご予約はお電話、LINE、WEBのいずれかにて承ります。</p>
                                    <p class="el_guideReserveContainer_hourTxt">受付時間　10:00 ~ 19:00</p>
                                </div>
                            </div>
                            <div class="bl_guideReserveContainer_btnWrapper">
                                <div class="bl_reserveBtnWrapper">
                                    ...
                                    <?php if (get_field('re-line-url', 'option')): ?>
                                        <a href="<?php echo get_field('re-line-url', 'option'); ?>" class="bl_reserveBtn bl_reserveBtn_brown" target="_blank">
                                            <div class="bl_reserveBtn_iconWrapper">
                                    ...
                                    <?php if (get_field('re-web-url', 'option')): ?>
                                        <a href="<?php echo get_field('re-web-url', 'option'); ?>" class="bl_reserveBtn " target="_blank">
                                            <div class="bl_reserveBtn_iconWrapper">
                    ...
                    <section class="bl_guideFlowSection">
                        <div class="bl_guideFlowSection_inner">
                            <hgroup class="bl_guideFlowSection_ttlWrapper">
                                <h2 class="el_guideFlowSection_ttl">Flow</h2>
                                <p class="el_guideFlowSection_subTtl">施術までの流れ</p>
                            </hgroup>
                            <div class="bl_guideFlowListWrapper">
                                <div class="swiper bl_guideFlowListSlider">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <div class="bl_guideFlowList_item">
                                                <img class="el_guideFlowList_item_img" src="<?php echo get_template_directory_uri(); ?>/assets/img/guide/flow-item01.jpg" alt="01.ご予約">
                                                <div class="bl_guideFlowList_item_txtWrapper">
                                                    <p class="bl_guideFlowList_item_ttl">01.ご予約</p>
                                                    <p class="bl_guideFlowList_item_txt">お電話またはLINE、WEBから、ご希望の日時でご予約ください。</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="bl_guideFlowList_item">
                                                <img class="el_guideFlowList_item_img" src="<?php echo get_template_directory_uri(); ?>/assets/img/guide/flow-item02.jpg" alt="02.ご来院・カウンセリング">
                                                <div class="bl_guideFlowList_item_txtWrapper">
                                                    <p class="bl_guideFlowList_item_ttl">02.ご来院・カウンセリング</p>
                                                    <p class="bl_guideFlowList_item_txt">予約日時になりましたらご来院ください。ご希望の施術やお悩みについてヒアリングさせていただき、医師より詳細な説明をさせていただきます。</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="bl_guideFlowList_item">
                                                <img class="el_guideFlowList_item_img" src="<?php echo get_template_directory_uri(); ?>/assets/img/guide/flow-item03.jpg" alt="03.施術">
                                                <div class="bl_guideFlowList_item_txtWrapper">
                                                    <p class="bl_guideFlowList_item_ttl">03.施術</p>
                                                    <p class="bl_guideFlowList_item_txt">カウンセリングの内容をもとに施術を行います。施術時間は内容によって異なりますが、一般的に数十分から数時間かかります。</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="bl_guideFlowList_item">
                                                <img class="el_guideFlowList_item_img" src="<?php echo get_template_directory_uri(); ?>/assets/img/guide/flow-item04.jpg" alt="04.アフターフォロー">
                                                <div class="bl_guideFlowList_item_txtWrapper">
                                                    <p class="bl_guideFlowList_item_ttl">04.アフターフォロー</p>
                                                    <p class="bl_guideFlowList_item_txt">施術後のケア方法や注意点について説明を受けます。必要に応じて、アフターフォローのための来院日を設定することもあります。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="bl_guidePageLower">
                <div class="bl_guidePageLower_inner">
                    <section class="bl_guideContentsSection">
                        <div class="bl_guideContentsSection_item">
                            <hgroup class="bl_guideContentsSection_item_ttlWrapper">
                                <h2 class="el_guideContentsSection_item_ttl">Payment</h2>
                                <p class="el_guideContentsSection_item_subTtl">お支払い方法</p>
                            </hgroup>
                            <div class="bl_guideContentsSection_item_txtWrapper">
                                <div class="bl_guideContentsSection_item_txtWrapper_txtWrapper">
                                    <p class="el_guideContentsSection_item_txtWrapper_txtWrapper_txt">お支払いは現金またはクレジットカードで承ります。</p>
                                </div>
                                <div class="bl_paymentListWrapper">
                                    <ul class="bl_paymentList">
                                        <li class="bl_paymentList_item">
                                            <img class="el_paymentList_item_img" src="<?php echo get_template_directory_uri(); ?>/assets/img/guide/visa.png" alt="VISA ">
                                        </li>
                                        <li class="bl_paymentList_item">
                                            <img class="el_paymentList_item_img" src="<?php echo get_template_directory_uri(); ?>/assets/img/guide/master.png" alt="Mastercard ">
                                        </li>
                                        <li class="bl_paymentList_item">
                                            <img class="el_paymentList_item_img" src="<?php echo get_template_directory_uri(); ?>/assets/img/guide/amex.png" alt="American Express ">
                                        </li>
                                        <li class="bl_paymentList_item">
                                            <img class="el_paymentList_item_img" src="<?php echo get_template_directory_uri(); ?>/assets/img/guide/jcb.png" alt="JCB ">
                                        </li>
                                        <li class="bl_paymentList_item">
                                            <img class="el_paymentList_item_img" src="<?php echo get_template_directory_uri(); ?>/assets/img/guide/diners.png" alt="Diners Club ">
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="bl_guideContentsSection_item">
                            <hgroup class="bl_guideContentsSection_item_ttlWrapper">
                                <h2 class="el_guideContentsSection_item_ttl">For minor</h2>
                                <p class="el_guideContentsSection_item_subTtl">未成年の方へ</p>
                            </hgroup>
                            <div class="bl_guideContentsSection_item_txtWrapper">
                                <div class="bl_guideContentsSection_item_txtWrapper_txtWrapper">
                                    <p class="el_guideContentsSection_item_txtWrapper_txtWrapper_txt el_guideContentsSection_item_txtWrapper_txtWrapper_txt_sp">18歳未満の方が施術を希望される場合、保護者同伴での<br>ご来院、もしくは「未成年同意書」の提出が必要です。</p>
                                    <p class="el_guideContentsSection_item_txtWrapper_txtWrapper_txt el_guideContentsSection_item_txtWrapper_txtWrapper_txt_sp">以下より同意書をダウンロードしていただき、<br>必ず親権者の方がご記入の上、ご来院時にお持ちください。</p>
                                </div>

                                <?php if (get_field('concent-file', 'option')): ?>
                                    <a href="<?php echo get_field('concent-file', 'option'); ?>" class="bl_guideContentsSection_dowonloadbtn" download>
                                        <p class="el_guideContentsSection_dowonloadbtn_txt">未成年同意書をダウンロード</p>
                                        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/common/download.svg" alt="ダウンロード">
                                    </a>
                                <?php endif; ?>
                            </div>
                        </div>
